...
# STUDENTS: for this example, __getitem__() must return a dict with entries {'input': x, 'label': y}
        ...
        y = self.normalized_data[idx,6:][0].astype('float32')
        dict = {'input': x, 'label': y}
        return dict
...
# STUDENTS: randomly split dataset into two data.DataLoaders, self.train_loader and self.test_loader
        ...
        self.train_loader = torch.utils.data.DataLoader(self.train_loader, **params)
        self.test_loader = torch.utils.data.DataLoader(self.test_loader, **params)
